...
1. [Fork](https://github.com/crazy-max/xcalxls2csv/fork) and clone the repository
...
7. Build the project: `docker buildx bake artifact-all`
8. Push to your fork and [submit a pull request](https://github.com/crazy-max/xcalxls2csv/compare)
